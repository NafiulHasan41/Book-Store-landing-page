    ...
    <div className="hero md:max-h-[700px]   rounded-3xl">
        <div className="hero-content flex-col lg:flex-row justify-between w-full gap-2 md:gap-4">
            ...
            <div className=" flex-1 text-start p-5">
                <h1 className=" text-2xl md:text-4xl text-black font-bold">{bookName} </h1>
                ...
                <div className=" text-start my-3"> 
                    <p className="text-[16px] text-gray-400 font-normal">Number of Page : <span className=" font-semibold text-black">    {totalPages} </span></p>
                    <p className="text-[16px] text-gray-400 font-normal">Publisher : <span className=" font-semibold text-black">         { publisher} </span></p>
                    <p className="text-[16px] text-gray-400 font-normal">Year of Publishing : <span className=" font-semibold text-black">{yearOfPublishing} </span></p>
                    <p className="text-[16px] text-gray-400 font-normal">Rating  <span className=" font-semibold text-black"> :           {rating} </span></p>
                </div>

                <div className="flex gap-5 text-[18px] font-semibold">
                <button className="btn bg-transparent border border-gray-400">Read</button>
                <button className="btn bg-[#59C6D2] border-none">Wishlist</button>
                </div>
